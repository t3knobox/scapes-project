...
def _fake_plan() -> Plan:
    return Plan(
        key="D major", bpm=72,
        subprompts=[
            SubPrompt(category="bass", durationSec=12, quantize="free", loop=True,
                      positive="deep low sustained drone, warm sub rumble"),
            SubPrompt(category="mid", durationSec=12, quantize="free", loop=True,
                      positive="warm mid pad, soft body"),
            SubPrompt(category="high", durationSec=11, quantize="free", loop=True,
                      positive="soft airy high shimmer"),
            ...
            SubPrompt(category="voice", durationSec=10, quantize="free", loop=True,
                      positive="wordless ethereal choir, soft breathy aah"),
